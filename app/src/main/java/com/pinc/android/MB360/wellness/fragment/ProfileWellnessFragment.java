...
import com.pinc.android.MB360.databinding.FragmentProfileWellnessBinding;
...
//personal information
    ...
    public void onDocumentClicked(UserDocumentsDetail document) {
        ...
        new ProfileWellnessFragment.DownloadFile(requireContext(), requireActivity(), "pdf").downloadFilePDF(document.getDocumentType(), document.getDocumentPath());
