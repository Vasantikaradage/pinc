...
public class BadgesDrawable extends Drawable {
    ...
    public BadgesDrawable(Context context) {
        ...
        mBadgePaint.setColor(ContextCompat.getColor(context.getApplicationContext(),R.color.primary_variant));
        mBadgePaint.setAntiAlias(true);
        mBadgePaint.setStyle(Paint.Style.FILL);
        mBadgePaint1 = new Paint();
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.primary_variant));
